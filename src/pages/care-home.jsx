  ...
  return <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 pb-20">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <Button onClick={handleNavigateToDaily} className="bg-gradient-to-br from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white rounded-2xl py-4 flex flex-col items-center space-y-2">
            <Bell className="w-6 h-6" />
            <span className="text-sm">护理日报</span>
          </Button>
          <Button onClick={handleNavigateToLeave} className="bg-gradient-to-br from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white rounded-2xl py-4 flex flex-col items-center space-y-2">
            <FileText className="w-6 h-6" />
            <span className="text-sm">请假申请</span>
          </Button>
          <Button onClick={handleNavigateToBill} className="bg-gradient-to-br from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white rounded-2xl py-4 flex flex-col items-center space-y-2">
            <DollarSign className="w-6 h-6" />
            <span className="text-sm">缴费账单</span>
          </Button>
        </div>
      </div>
