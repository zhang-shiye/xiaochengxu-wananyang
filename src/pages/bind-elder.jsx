...
export default function BindElder(props) {
  const {
    toast
  } = useToast();
  ...
  return <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          {/* 返回按钮 */}
          <div className="mb-6">
            <Button variant="ghost" size="sm" onClick={() => props.$w.utils.navigateBack()} className="text-amber-700 hover:text-amber-900 hover:bg-amber-100">
